 ...
 */
public class Sega extends javax.swing.JFrame {
    ...
    private void btnIniciarJuegoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarJuegoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Sega.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
